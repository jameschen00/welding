 ...
 * Class PropertyType
 */
class PropertyType extends AbstractSymfonyType
{
    /**
     * @var AbstractManager
     */
    ...
    public function buildGrid(GridBuilder $builder, $options = array())
    {
        ...
        //menu_id
        $column = $builder->addColumn('property_id', 'text', array(
            'title' => $this->translator->trans('property.id'),
            'width' => 50,
        ));
        ...
        $column = $builder->addColumn('name', 'text', array(
            'title' => $this->translator->trans('property.name'),
        ));
